...
> **本節の `S-1`〜`S-10` のうち、`S-1`・`S-5`・`S-7`・`S-8` の一部は本改訂の射程である**(裁定 `D-14`)。**残る `S-2`・`S-3`・`S-4`・`S-6`・`S-9`・`S-10`・`S-8` の残部は PR #3 の射程**で(**`S-9` は裁定 `D-15`**)、**2 節の送り先表が正**である。
