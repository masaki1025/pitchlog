...
| **Codex CLI の要更新** | **0.157.0(2026-09-25)で "Added GPT-6 Sol and Luna to the model catalog … migration prompts for older models"**。最新安定版は 0.157.1(2026-09-26)。本機は 0.153.4 → `gpt-6-sol` / `gpt-6-luna` を使うには **CLI 更新が前提** | ✔ `gh release view rust-v0.157.0 -R openai/codex` |
