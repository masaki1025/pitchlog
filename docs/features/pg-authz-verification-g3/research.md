...
**本調査の時点での**改訂 4 の射程 7 項目(`S-2` `S-3` `S-4` `S-6` `S-9` `S-10` と `S-8` の一部)について、
(**調査の結果を受けた PO 裁定 `D-22`〔2026-09-14〕で、射程は `S-9` + `S-10` へ絞られた。
残る 5 項目の送り先は `plan.md` 2 節が正**)
...
3. ~~**`FR-041/list_item-014` の `reason_code` 分裂**~~ → **裁定済み**(`D-23`・2026-09-14)。
   **畳まない** — 行の属性として扱い、owner 単位の不変条件は `receiving_task_id` にだけ課す。
