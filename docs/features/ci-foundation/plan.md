...
| --- | --- | --- |
| `docs/development/dev-harness-design-2026-08-07.md` | **7 章に frontmatter 併記の状態管理規約を追加(構造的規約変更)**+ 10.1 実装追随注記(採用ツール・SHA)+ 10.2/13 章に保護後送り注記 + 変更履歴(**v1.0 → v1.1**) | **finalize-doc**(規約変更 + 版繰り上げ — 7.6 決定表) |
