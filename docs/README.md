...
| [開発ハーネス設計書](development/dev-harness-design-2026-08-07.md) | **in-review**(v1.6 改訂中 — Phase 4 を複数 PR へ分割。計画は PO 承認済み) | 1.6 | 2026-08-16 |
| [ハーネス運用評価台帳](development/harness-evaluation.md) | **approved**(v1.0 — 敵対レビュー9周 → PO 承認) | 1.0 | 2026-08-16 |
