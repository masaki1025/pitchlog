...
| [開発ハーネス設計書](development/dev-harness-design-2026-08-07.md) | **in-review**(v1.12 起案 — **7.3 収束規則の再設計**: 適用版の原則・終端遷移表・重大度定義・差分再レビュー・依頼文規約・エスカレーションと 6 周警告・射程宣言。確定ゲートは 7.3-1 により v1.11 規則で運用中) | 1.12 | 2026-09-01 |
