...
| 文書 | 状態 | 版 | 最終更新 |
| --- | --- | --- | --- |
| [要件定義書](requirements/requirements-pitchlog-2026-07-22.md) | **in-review**(v2.1 起案中 — NFR-018 の達成条件。v2.0 は敵対レビュー5周 → PO 承認) | 2.1 | 2026-08-18 |
| [改善台帳](improvements-from-baseball-scoring.md) | **in-review**(v1.1 起案中 — 要件書 v2.1 への追随。v1.0 は要件書 v2.0 と同一ゲートで確定) | 1.1 | 2026-08-18 |
...
| [ハーネス運用評価台帳](development/harness-evaluation.md) | **approved**(v1.0 — 敵対レビュー9周 → PO 承認) | 1.0 | 2026-08-18 |
