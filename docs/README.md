...
| [開発ハーネス設計書](development/dev-harness-design-2026-08-07.md) | in-review(v1.10 — NFR-021 の継続検証基盤(`win-setup`)を不採用とし、WSL 固有の継続検証を要件書 NFR-021 の 2 時点の手動再現へ一本化。確定ゲート中) | 1.10 | 2026-08-26 |
