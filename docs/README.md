...
| [ハーネス運用評価台帳](development/harness-evaluation.md) | **approved**(v1.0 — 敵対レビュー9周 → PO 承認。H-20・H-78・H-79・H-53・H-81・**H-22・H-42・H-61**・**H-86/H-21/H-68** の実測・**H-85 新設**〔PR #34〕/ **H-68 対応済み・H-75 部分対応**〔7.3 v1.12 の条文化〕+ H-42/H-39/H-12/H-8 補記・候補 1 件〔PR #35〕/ **H-12 再発補記**〔TSK-226〕/ **H-12 3 件目・H-19 ⑥・候補 1 件**〔TSK-308〕/ **H-87 新設・H-53/H-81 実測**〔TSK-312〕/ **H-88 新設・H-85 実測・候補 1 件**〔TSK-278〕/ **H-12 部分対応**(コード側 paths 充填)・**H-85 実測**〔TSK-281〕/ **候補 2 件**〔TSK-269 — 委任粒度と現在地導出の欠番・計画レビューの終端条件〕) | 1.0 | 2026-09-04 |
