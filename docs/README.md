...
| [開発ハーネス設計書](development/dev-harness-design-2026-08-07.md) | **approved**(v1.9 — `onboarding.md` の approved 化を Phase 4 完了時受入の前提 PR として位置づけ。敵対レビュー7周 → PO 承認) | 1.9 | 2026-08-24 |
| [ハーネス運用評価台帳](development/harness-evaluation.md) | **approved**(v1.0 — 敵対レビュー9周 → PO 承認) | 1.0 | 2026-08-24 |
...
| [オンボーディング](development/onboarding.md) | **approved**(v1.0 — 本文の完成と受入プロファイルへの整合。Phase 4 完了時受入の合格 5 項目すべてに到達する手順) | 1.0 | 2026-08-25 |
| [GitHub リポジトリ設定手順](development/github-setup.md) | **approved**(v1.1 — 敵対レビュー2周 → PO 承認) | 1.1 | 2026-08-24 |
| [NFR-021 受入証跡の運用](ops/nfr021-acceptance/README.md) | **approved**(v1.1 — ブートストラップ手順へ前提 PR を挿入。敵対レビュー3周 → PO 承認) | 1.1 | 2026-08-24 |
