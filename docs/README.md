...
| [開発ハーネス設計書](development/dev-harness-design-2026-08-07.md) | **approved**(v1.8 — 10.1 と 13 章の 8 箇所を改訂。敵対レビュー6周 → PO 承認) | 1.8 | 2026-08-23 |
| [ハーネス運用評価台帳](development/harness-evaluation.md) | **approved**(v1.0 — 敵対レビュー9周 → PO 承認) | 1.0 | 2026-08-23 |
