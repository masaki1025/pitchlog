...
| 文書 | 状態 | 版 | 最終更新 |
| --- | --- | --- | --- |
| [要件定義書](requirements/requirements-pitchlog-2026-07-22.md) | **in-review**(v1.9 改訂を確定ゲートで検証中) | 1.9 | 2026-08-11 |
...
| [開発ハーネス設計書](development/dev-harness-design-2026-08-07.md) | **in-review**(v1.4 改訂を確定ゲートで検証中) | 1.4 | 2026-08-12 |
