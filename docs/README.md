...
| 文書 | 状態 | 版 | 最終更新 |
| --- | --- | --- | --- |
| [要件定義書](requirements/requirements-pitchlog-2026-07-22.md) | **in-review**(v2.7 — TSK-322: `NFR-020` の前提不成立時の挙動を条文化。同期プロトコル設計 v0.3 と単一ゲートで一括検証。**v2.5 は TSK-267 の先約**) | 2.7 | 2026-09-06 |
...
| [同期プロトコル設計](design/sync-protocol.md) | **in-review**(v0.3 — TSK-322: 参照規約・要件帰属・同期境界・undo・時刻記述・申し送りを改訂。要件書 v2.7 と単一ゲートで一括検証。**v0.2 は TSK-267 の先約**) | 0.3 | 2026-09-06 |
