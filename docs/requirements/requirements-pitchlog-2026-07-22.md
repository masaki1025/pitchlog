...
### 7.1 技術・アーキテクチャ制約
- 技術スタック: Python / FastAPI + Vue.js + TypeScript / PostgreSQL（本番=Supabase、開発=Windowsネイティブ or Docker）。変更には承認を要する（v1.8: フロントエンドを React から Vue.js へ変更 — 決定は [ADR-002](../adr/ADR-002-frontend-vue.md)）
