...
| 1.5 | 2026-08-16 | **ハーネス設計レビュー是正 第1弾(節更新 — 版は上げない・7.6-3 前段)**: **6.3 へ保護未適用の縮退注記を追記**(v1.1 で 2.3・6.2・10.1・12.1・12.2 へ伝播した縮退注記の 6.3 への漏れ是正 — 10.2 のリスク受容記録と `github-setup.md` 2 章の管理手続への参照に限定し、新規統制・境界定義は含めない)。計画: `docs/features/harness-design-review/plan.md` | approved |
