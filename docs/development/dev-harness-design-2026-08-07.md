...
- **本数の数え方**（v1.9）: **監査 PR と `P4-後` を除く、論理スロット + Phase 4 の前提 PR** を数える。したがって**成功時 7 本**（4-1 〜 4-6 の 6 本 + 前提 PR 1 本）・**4-6 の再試行が n 回なら 7+n 本**。**監査 PR はブートストラップと失敗閉塞で本数が変わるため、「物理 PR 総数」は固定しない**
