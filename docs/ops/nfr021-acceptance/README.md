...
5. **Phase 4 完了時受入の前提 PR** は、設計書 13 章「Phase 4 完了時受入の前提 PR」の
   **マージ条件を満たしたこと**(**本書 v1.1 も同節の対象である**)**を確認してから**
   `develop` へ統合する。統合後の `develop` で `docs/development/onboarding.md` の
   frontmatter が `status: approved`、版が v1.0 であることを確認する。
