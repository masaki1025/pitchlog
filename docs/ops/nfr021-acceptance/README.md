...
5. **Phase 4 完了時受入の前提 PR** は、設計書 13 章「Phase 4 完了時受入の前提 PR」の
   **マージ条件を満たしたことを確認してから** `develop` へ統合する(**同 PR に含まれる
   確定ゲート対象の正本はすべて approved 化してからマージする** — 本書 v1.1 自身も
   その対象である)。統合後の `develop` で `docs/development/onboarding.md` の
